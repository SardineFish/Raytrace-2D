...
let redRect = material(translate(rect(50, 50), -0, -120), rgb(255, 0, 0));
let blueRect = material(translate(rect(50, 50), -50, 0), rgb(0, 255, 255));
let graph =
    union(
        union(
            blend(
...
config({
    ...
    thread: 4,                              // The amount of workers to render ray-trace. Too many workers may cause browser crash due to the memory limit.
